...
#define MONGOC_USER_SET_CFLAGS "-O2 -fPIC -march=native -mtune=native -fno-gcse -m64"

#define MONGOC_USER_SET_LDFLAGS "-Wl,-rpath='$$ORIGIN/../lib' -Wl,-rpath-link='$$ORIGIN/../lib'"
